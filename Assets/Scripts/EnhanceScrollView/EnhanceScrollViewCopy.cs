...
public class EnhanceScrollViewCopy : MonoBehaviour
{
    ...
    private static EnhanceScrollViewCopy instance;
    public static EnhanceScrollViewCopy GetInstance
    {
        get { return instance; }
    }
    ...
    void Start()
    {
        ...
        for (int i = count - 1; i >= 0; i--)
        {
            ...
            {
                UDragEnhanceViewCopy script = obj.GetComponent<UDragEnhanceViewCopy>();
                if (script != null)
                    script.SetScrollView(this);
            }
            index++;
